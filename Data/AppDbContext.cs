    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Story>().HasData(
            ...
            new Story {
                ...
                CoverImage = "https://books.google.com/books/content?id=GmnY0AEACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
                Status = "Đang ra",
                ViewCount = 25000,
            ...
            new Story {
                ...
                CoverImage = "https://books.google.com/books/content?id=rtdt0AEACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
                Status = "Đang ra",
                ViewCount = 45000,
